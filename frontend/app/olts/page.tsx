    ...
    <main className="min-h-screen bg-slate-950 p-6 text-slate-100">
      <div className="mx-auto max-w-7xl">
        <nav className="mb-8 flex flex-wrap items-center gap-3 border-b border-slate-800 pb-4 text-sm">
          <Link href="/dashboard" className="font-bold text-cyan-400">RoutingNMS</Link>
          <Link href="/dashboard" className="text-slate-400 hover:text-white">Dashboard</Link>
          <Link href="/devices" className="text-slate-400 hover:text-white">Devices</Link>
          <Link href="/olts" className="rounded bg-slate-800 px-3 py-1 text-white">OLTs</Link>
          <Link href="/incidents" className="text-slate-400 hover:text-white">Incidents</Link>
          <Link href="/topology" className="text-slate-400 hover:text-white">Topology</Link>
        </nav>
        <div className="mb-8">
