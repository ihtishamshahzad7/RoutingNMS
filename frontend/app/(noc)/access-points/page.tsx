        ...
        <section className={card}>
          ...
          <div className="mt-5 space-y-3">
            {loading ? (
              ...
              aps.map(ap => (
                <div key={ap.id} className="rounded-[6px] border border-[#21262D] bg-[#0D1117] p-4">
                  <div className="flex items-center justify-between">
                    <div className="font-medium">
                      {ap.name} <span className="ml-2 rounded bg-[#21262D] px-1.5 py-0.5 text-[10px] uppercase text-[#58A6FF]">{ap.apType}</span>
                    </div>
                    <div className="flex gap-2">
                      <button onClick={() => setEditing(ap)} className="rounded-[6px] border border-[#30363D] px-3 py-1.5 text-xs hover:bg-[#21262D]">Edit</button>
                      <button onClick={() => remove(ap)} className="rounded-[6px] border border-[#672525] px-3 py-1.5 text-xs text-[#F78166] hover:bg-[#2D1212]">Delete</button>
                    </div>
                  </div>
              ...
              <div className="py-8 text-center text-[#8B949E]">No access points yet.</div>
            )}
          </div>
        </section>
