...
const PROTECTED_PREFIXES = ["/dashboard", "/devices", "/incidents", "/olts", "/topology", "/syslog"];
...
export const config = {
  matcher: ["/", "/dashboard/:path*", "/devices/:path*", "/incidents/:path*", "/olts/:path*", "/topology/:path*", "/syslog/:path*"],
};
