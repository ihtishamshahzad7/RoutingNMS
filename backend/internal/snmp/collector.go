...
func (Collector) Connect(ctx context.Context, target Target) (*gosnmp.GoSNMP, error) {
	...
	client := &gosnmp.GoSNMP{
		...
		Retries:   uint8(max(0, target.Retries)),
		Version:   version,
		Logger:    nil,
...
func authProtocol(value string) gosnmp.SnmpV3AuthProtocol {
	...
	case "SHA224": return gosnmp.SHA224
	case "SHA256": return gosnmp.SHA256
	case "SHA384": return gosnmp.SHA384
	case "SHA512": return gosnmp.SHA512
	default: return gosnmp.NoAuth
	}
}
...
func privProtocol(value string) gosnmp.SnmpV3PrivProtocol {
	...
	case "AES192": return gosnmp.AES192
	case "AES256": return gosnmp.AES256
	default: return gosnmp.NoPriv
	}
}
