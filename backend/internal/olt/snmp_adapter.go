...
func onuIndex(id,base string)string{id=strings.Trim(id,".");base=strings.TrimRight(strings.Trim(base),".");if base!=""{p:=base+".";if strings.HasPrefix(id,p){return strings.TrimPrefix(id,p)}};return ""}
